...
window.navigate = function(page, linkEl) {
  ...
  const titles = { dashboard:'Dashboard', products:'Products', categories:'Categories', badges:'Badges', reviews:'Reviews', trending:'Trending', 'store-settings':'Store Settings', 'data-policy':'Data Policy Page' };
